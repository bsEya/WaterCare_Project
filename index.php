...
<body>
  ...
  <?php
    ...
    try {
      ...
      $query1 = $pdo->query('SELECT amount1 AS total1 FROM donation_totals');
      $result1 = $query1->fetch(PDO::FETCH_ASSOC);
      $raised1 = intval($result1['total1']);
      
      $query2 = $pdo->query('SELECT amount2 AS total2 FROM donation_totals');
      $result2 = $query2->fetch(PDO::FETCH_ASSOC);
      $raised2 = intval($result2['total2']);
      
      $query3 = $pdo->query('SELECT amount3 AS total3 FROM donation_totals');
      $result3 = $query3->fetch(PDO::FETCH_ASSOC);
      $raised3 = intval($result3['total3']);
      
      $query4 = $pdo->query('SELECT amount4 AS total4 FROM donation_totals');
